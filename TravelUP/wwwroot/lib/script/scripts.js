$(function () {
    ...
    $(window).ready(i), $(window).on("resize", i), $(".sidebartoggler").on("click", function () {
        ...
        $(".fix-header .header").stick_in_parent({}), $(".nav-toggler").click(function (e) {
            $("body").toggleClass("show-sidebar"), $(".nav-toggler i").toggleClass("fa fa-bars"),
